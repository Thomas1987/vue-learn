    ...
    <Row :gutter="14">
      ...
      <i-col span="8" class="padding-left-10">
        <Card>
          ...
          <Row type="flex" justify="center" align="middle" class="countto-page-row">
            <div class="count-to-con">
              <count-to :end="2534" :decimals="2" count-class="count-text" unit-class="unit-class">
                <span slot="left" class="slot-text">Total:&nbsp;</span>
                <span slot="right" class="slot-text">&nbsp;times</span>
              </count-to>
            </div>
          ...
          <Row type="flex" justify="center" align="middle" class="countto-page-row">
            <div class="count-to-con">
              <count-to :delay="500" :simplify="true" :unit="unit2" :end="integratedEndVal" count-class="count-text" unit-class="unit-class">
                <span slot="left" class="slot-text">原始数据:&nbsp;{{ integratedEndVal }}&nbsp;=>&nbsp;</span>
                <span slot="right" class="slot-text">&nbsp;times</span>
              </count-to>
            </div>
          </Row>
